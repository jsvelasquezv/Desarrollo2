      ...
      <tbody>       
        <?php foreach ($_SESSION['comprasCliente'] as $key) {
          ?> <tr>
            ...
            ?><td><a href="../controladores/CoordinadorVenta.php?down=<?php echo $key['id_factura']."&product=".$key['nombre'] ?>" class="grey-text text-darken-3 tooltipped" name="down" id="down" data-tooltip="Cancelar" data-position="right"><i class="mdi-action-highlight-remove small"></i></a></td> 
            <?php }else{ ?>
