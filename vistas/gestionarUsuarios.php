...
<body>
			...
			<tbody>				
				<?php foreach ($_SESSION['usuarios'] as $key) {
					?> <tr>
						 ...
						 <td><a href="../controladores/CoordinadorUsuario.php?editUsuario=<?php echo $key['documento'] ?>" class="grey-text text-darken-3 tooltipped" name="edit" id="edit" data-position="right" data-tooltip="Editar"><i class="mdi-image-edit small"></i></a></td>
						 <td><a href="../controladores/CoordinadorUsuario.php?down=<?php echo $key['documento'] ?>" class="grey-text text-darken-3 tooltipped" name="down" id="down" data-position="right" data-tooltip="Dar de baja"><i class="mdi-action-thumb-down small"></i></a></td> <?php
					?> </tr> <?php 
				} ?>
			</tbody>
		</table>	
	...
	<div class="fixed-action-btn" style="bottom: 45px; right: 45px;">
		<a class="btn-floating btn-large waves-effect waves-light red right modal-trigger tooltipped" href="../vistas/registrarUsuario.php" data-position="left" data-tooltip="Registrar Usuario"><i class="mdi-content-add"></i></a>
	</div>
